<%@ page import="mx.edu.utez.newcursoinduccion.model.Usuario" %>
                            ...
                            <div class="card-body p-md-5 mx-md-4">
                                ...
                                <div class="text-center">
                                    <h4 class="mt-1 mb-5 pb-1">
                                        <% if (request.getSession().getAttribute("usuario") == null) { %> Registrar
                                        Usuario <% } else { %> Actualizar Usuario <% } %>
                                    </h4>
                                    <p>
                                        <% if (request.getSession().getAttribute("usuario") == null) { %> Completa los
                                        datos para registrar un nuevo usuario <% } else { %> Modifica los datos del
