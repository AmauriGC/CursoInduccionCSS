...
import mx.edu.utez.newcursoinduccion.utils.GmailSender;
import mx.edu.utez.newcursoinduccion.utils.SimpleRandomStringGenerator;
...
public class ContraServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String enlace = "http://localhost:8080/NewCursoInduccion_war_exploded/recuContra?codigo=" + codigo;
